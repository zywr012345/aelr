...
<div class="container goods-form-2">
    ...
    <mt-field label="C团折扣"  :readonly="ifSpec" v-model="goods.goods_c_price"></mt-field>
    <mt-field label="B团折扣"  :readonly="ifSpec" v-model="goods.goods_b_price"></mt-field>
            ...
            <div class="common-popup-content">
                <div v-for="(spvalue_key,k) in specArray.spvalue_key" :key="k">
                   ...
                   <mt-field label="零售折扣"  v-model="spec[spvalue_key].goods_l_price"></mt-field>
                    ...
                    <mt-field label="C团折扣" v-model="spec[spvalue_key].goods_c_price"></mt-field>
                    <mt-field label="B团折扣" v-model="spec[spvalue_key].goods_b_price"></mt-field>
