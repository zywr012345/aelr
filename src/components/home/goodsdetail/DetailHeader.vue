...
<template>
	<div>
		<div class="ui-detail-header">
			...
			<span class="iconfont right" @click="popupMore">&#xe680;<div v-if="showDot" class="dot"></div></span>
		</div>
		<header-more :goods_id="goods_id" :share_info="share_config" v-show="popupVisible" :showDot="showDot"></header-more>
	</div>
</template>
