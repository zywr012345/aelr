<template>
    ...
    <div v-if="type==2" class="ui-form-area" @click="onRegion">
      <div class="ui-form-control"><input type="text" readonly="readonly" v-model="area_info" placeholder="地区" class="ui-form-input"></div>
    </div>
    ...
    <region-picker ref="picker" :valm="area_id" v-on:onConfirm="onPickerConfirm"></region-picker>
...
export default {
  ...
  created: function () {
    // console.log('初始化',this.area_info,this.area_id);
