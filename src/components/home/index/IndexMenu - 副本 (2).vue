<template>
  <div class="menu clear-fix">
    ...
    <div class="menu-item">
      <img class="menu-item-icon" @click="goMemberIndex" src="../../../assets/image/home/home-index-menu3.png" />
      <span class="menu-item-title">零售</span>
    </div>
    <div class="menu-item" @click="goMemberIndex">
      <img class="menu-item-icon" src="../../../assets/image/home/home-index-menu5.png" />
      <span class="menu-item-title">批发</span>
    </div>
    <div class="menu-item" @click="goMemberIndex">
      <img class="menu-item-icon" src="../../../assets/image/home/home-index-menu8.png" />
      <span class="menu-item-title">B团</span>
    </div>
    <div class="menu-item" @click="goMemberIndex">
      <i class="iconfont bg-4">&#xe674;</i>
      <span class="menu-item-title">C团</span>
    </div>
    <div class="menu-item" @click="goMemberIndex">
      <i class="iconfont bg-2">&#xe68c;</i>
      <span class="menu-item-title">集采</span>
    </div>
