<template>
  <div class="container">
    <div class="common-header-wrap">
      <mt-header title="社区团管理" class="common-header">
        <mt-button slot="left" icon="back" @click="$router.go(-1)"></mt-button>
      </mt-header>
    </div>
    <mt-field label="社区团链接" type="text" :readonly="true" :value="inviter_url"></mt-field>
    <div @click='weixinVisible=true'><mt-cell class="menu-item" title="社区团公众号" is-link></mt-cell></div>
    <div @click='posterVisible=true'><mt-cell class="menu-item" title="社区团海报" is-link></mt-cell></div>
    <div @click='$router.push({name:"MemberInviterUser"})'><mt-cell class="menu-item" title="社区团成员" is-link></mt-cell></div>
    <div @click='$router.push({name:"MemberInviterOrder"})'><mt-cell class="menu-item" title="社区团业绩" is-link></mt-cell></div>
   <div @click='$router.push({name:"MemberInviterStorelist"})'><mt-cell class="menu-item" title="社区团商家" is-link></mt-cell></div>
    <!--推广公众号-->
    <mt-popup v-model="weixinVisible" position="right" class="common-popup-wrapper">
      <div class="common-header-wrap">
        <mt-header title="社区团公众号" class="common-header">
    ...
    <mt-popup v-model="posterVisible" position="right" class="common-popup-wrapper">
      <div class="common-header-wrap">
        <mt-header title="社区团海报" class="common-header">
