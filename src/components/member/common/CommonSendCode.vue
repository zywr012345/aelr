<template>
  <div class="common-send-code">
      ...
      <mt-field label="验证码" v-model="verifyCode">
          <mt-button @click="sendAuthCode" class="btn" type="default" size="small" plain>{{sendStateText}}</mt-button>
      </mt-field>
      <mt-button class="ds-button-large" type="primary" @click='checkAuthCode'>下一步</mt-button>
  </div>
</template>
...
<style  lang="scss" scoped>
    .common-send-code {position:relative;z-index:100;
        .btn{width:4rem}
        .mint-radiolist {
            display: flex;
            .mint-cell {
