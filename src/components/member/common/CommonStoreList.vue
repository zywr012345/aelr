...
<div class="qy"><mt-field label="商家查询：" v-model="keyword"></mt-field></div>
...
import { getStoreList0,getStoreNearbyList0,savetuan, tuanlist } from '../../../api/homesearch'
...
console.log(res)
  ...
  test () {
	 tuanlist(this.areaid, this.token).then(res => {console.log(res)})
},
    /**
     * getList: 构建数据
