...
<template>
    <div>
        <div class="common-header-wrap">
            <mt-header title="兑换详情" class="common-header">
        ...
        >
            <div class="image">
                <span>{{order_info.point_orderstatetext}}</span>
            </div>

            <div class="address">
                <div>
                    <span>{{ orderaddress_info.pointoa_truename }}</span>
                    <span class="mobile">{{ orderaddress_info.pointoa_mobphone }}</span>
                </div>
            ...
            <div class="detail">
                <div class="number">
                    ...
                    <p>
                        下单时间：{{order_info.point_finnshedtime}}
                    </p>
                </div>
            ...
            >
                ...
                <label class="amount"
                >实付款 : <span> {{ order_info.point_allpoint }}积分</span>
                </label>
            </div>
...
export default {
  ...
  created: function () {
    if (this.$route.query.point_orderid) {
      getOrderInfo(this.$route.query.point_orderid).then(res => {
