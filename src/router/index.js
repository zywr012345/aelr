  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        // 团分类
        { path: 'tuanclass', name: 'HomeTuanclass', component: HomeTuanclass, meta: { footer: { show: true } } },
        // 店铺分类
...

    {
      ...
      children: [
        ...
        // 推广商家列表 
       { path: 'inviter_storelist', name: 'MemberInviterStorelist', component: MemberInviterStorelist, meta: { footer: { show: true } } },
        // 活动记录
    ...
    },
    {
      ...
      children: [
        ...
        // 摄像头
        { path: 'camm', name: 'SellerCamm', component: SellerCamm, meta: { footer: { show: true } } },
       { path: 'jinhuo', name: 'SellerJinhuo', component: SellerJinhuo, meta: { footer: { show: true } } },
      ]
    }
